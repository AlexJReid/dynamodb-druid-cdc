...
"OldImage","OldImage",-802379691),eg=new K(null,"region","region",270415120);function Cf(a,b){return cd($c,nf(function(c){var d=X(c,0,null);c=X(c,1,null);return v(tf.g(c))?new od(null,2,5,ud,[d,tf.g(c)],null):null},pf(a,b)))}function Df(a,b){var c=Zc(b);b=I.l(c,cg,null);var d=I.l(c,Af,!1);c=I.l(c,sf,0);return ec.J(a,cg,b,$b([sf,c,Af,d,vf,v(d)?-1:1]))}var ng=function ng(a){for(var c=[],d=arguments.length,e=0;;)if(e<d)c.push(arguments[e]),e+=1;else break;return ng.J(arguments[0],arguments[1],2<c.length?new N(c.slice(2),0,null):null)};
